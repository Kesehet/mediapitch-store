...
$displayPrice=public_product_price($review);
$relatedItems=(new \MediaPitch\Repositories\RelatedContentRepository())->forContent((int)$review['id'],!empty($review['category_id'])?(int)$review['category_id']:null);
