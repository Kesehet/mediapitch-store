...
<label class="span-2">Tags <small>comma-separated; up to 20</small><input name="tags" maxlength="1000" placeholder="smartphones, battery life, camera" value="<?= e($r['tags'] ?? '') ?>"></label>
