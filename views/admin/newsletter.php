...
<section class="admin-card">
  ...
  <form method="get" action="/admin/newsletter.php" class="admin-filter-row" style="display:flex;gap:10px;flex-wrap:wrap;align-items:end;margin-bottom:18px">
    ...
    <a class="button secondary" href="<?= e('/admin/newsletter.php?'.http_build_query(['q'=>$query,'status'=>$status,'export'=>'csv'])) ?>">Export CSV</a>
  </form>
