...
(function(){
  ...
  const galleryPicker=document.getElementById('product-gallery-picker');
  const gallery=document.getElementById('product-gallery');
  const addGallery=document.getElementById('add-gallery-image');
  ...
  if(title&&slug){
    ...
    slug.addEventListener('input',()=>{slugManuallyEdited=slug.value.trim()!=='';});
    title.addEventListener('input',()=>{if(!slugManuallyEdited)slug.value=slugify(title.value);});
