...
$adminChartsCssVersion = (string) @filemtime($assetRoot . 'admin-charts.css');
$adminEditorJsVersion = (string) @filemtime($assetRoot . 'admin-editor.js');
$adminUxJsVersion = (string) @filemtime($assetRoot . 'admin-ux.js');
$adminChartsJsVersion = (string) @filemtime($assetRoot . 'admin-charts.js');
$adminMediaCssVersion = (string) @filemtime($assetRoot . 'admin-media.css');
$adminMediaJsVersion = (string) @filemtime($assetRoot . 'admin-media.js');
...
<aside class="admin-sidebar">
  ...
  <nav>
    ...
    <?php if($isAdmin):?><a class="<?= (str_starts_with($currentPath,'/admin/sender')||str_starts_with($currentPath,'/admin/newsletter'))?'active':'' ?>" href="<?= e(url('admin/sender')) ?>">Email / Sender</a><?php endif;?>
